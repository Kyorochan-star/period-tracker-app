...
# ① 生理開始記録
@app.post("/periods", status_code=status.HTTP_201_CREATED)
...
# ② 生理終了記録 / 生理期間更新
@app.post("/periods/{period_id}", status_code=status.HTTP_200_OK)
...
@app.get("/periods/{period_id}", status_code=status.HTTP_200_OK)
